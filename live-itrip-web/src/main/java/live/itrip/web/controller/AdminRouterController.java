...
//        }
    ...
    private void getProductInitDatas(Model model) {
        ...
        List<AdminDictItem> listType = new ArrayList<AdminDictItem>();
        List<AdminDictItem> listDays = new ArrayList<AdminDictItem>();
        List<AdminDictItem> listCity = new ArrayList<AdminDictItem>();
        List<AdminDictItem> listTraffic = new ArrayList<AdminDictItem>();
        List<AdminDictItem> listDinner = new ArrayList<AdminDictItem>();
        List<AdminDictItem> listHotel = new ArrayList<AdminDictItem>();
        ...
        List<WebStaticInfo> listCosts = new ArrayList<WebStaticInfo>();
        List<WebStaticInfo> listReserves = new ArrayList<WebStaticInfo>();
        List<WebStaticInfo> listNotices = new ArrayList<WebStaticInfo>();
        if (infoList != null) {
