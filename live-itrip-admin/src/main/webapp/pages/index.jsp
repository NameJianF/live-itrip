...
<head>
    ...
    <title>iTrip.live | Dashboard</title>

    <c:import url="importcss.jsp"/>

    <link href="/css/itrip/closetabs.css" rel="stylesheet">
</head>

<body style="height: 100%">
<div id="wrapper">
    <nav class="navbar-default navbar-static-side" role="navigation" style="height: 98%">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.jsp#">
                             ...
                             </span> <span class="text-muted text-xs block">${user.email}
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row  border-bottom white-bg dashboard-header" id="content-wrapper">
    ...
    <div id="right-sidebar">
        <div class="sidebar-container">
            ...
            <ul class="nav nav-tabs navs-3">
                ...
                <li><a data-toggle="tab" href="index.jsp#tab-2">
                    Projects
                </a></li>
                <li class="">
                    <a data-toggle="tab" href="index.jsp#tab-3">
