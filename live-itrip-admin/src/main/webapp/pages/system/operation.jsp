...
<div class="row">
    <div class="ibox-content table-responsive">
        ...
        <table class="table table-hover table-bordered dataTables-example" id="tabOperation" style="font-size: 14px;">
            <thead>
            <tr>
                <th>ID</th>
                <th>操作名称</th>
...
<div class="modal fade modal-default" id="formEditOperation">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="formEditTitle">操作编辑</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="publicBtn" class="btn   btn-primary" onclick="editSaveOperationInfo()">确定
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<script src="/javascript/system/operation.js"></script>
