            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="profile_2.html#">
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-bar-chart-o"></i> <span
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-edit"></i> <span class="nav-label">Forms</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li class="active">
                    <a href="profile_2.html#"><i class="fa fa-desktop"></i> <span class="nav-label">App Views</span>
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-files-o"></i> <span
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-globe"></i> <span
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-flask"></i> <span
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-table"></i> <span class="nav-label">Tables</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-shopping-cart"></i> <span
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-picture-o"></i> <span
                ...
                <li>
                    <a href="profile_2.html#"><i class="fa fa-sitemap"></i> <span
                            class="nav-label">Menu Levels </span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li>
                            <a href="profile_2.html#">Third Level <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="profile_2.html#">Third Level Item</a>
                                </li>
                                <li>
                                    <a href="profile_2.html#">Third Level Item</a>
                                </li>
                        ...
                        <li><a href="profile_2.html#">Second Level Item</a></li>
                        <li>
                            <a href="profile_2.html#">Second Level Item</a></li>
                        <li>
                            <a href="profile_2.html#">Second Level Item</a></li>
                    </ul>
                </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="profile_2.html#"><i
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <ul class="list-unstyled file-list">
                                <li><a href="profile_2.html"><i class="fa fa-file"></i> Project_document.docx</a></li>
                                <li><a href="profile_2.html"><i class="fa fa-file-picture-o"></i>
                                    Logo_zender_company.jpg</a></li>
                                <li><a href="profile_2.html"><i class="fa fa-stack-exchange"></i>
                                    Email_from_Alex.mln</a></li>
                                <li><a href="profile_2.html"><i class="fa fa-file"></i> Contract_20_11_2014.docx</a>
                                </li>
                                <li><a href="profile_2.html"><i class="fa fa-file-powerpoint-o"></i>
                                    Presentation.pptx</a></li>
                                <li><a href="profile_2.html"><i class="fa fa-file"></i> 10_08_2015.docx</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-avatar">
                            <a href="profile_2.html" class="pull-left">
